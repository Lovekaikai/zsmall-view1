<template>
	<view class="uni-numbox">
		...
		<input class="uni-numbox__value" type="number" :disabled="disabled" :value="inputValue" @blur="_onBlur" @input="_onBlur">
...
<script>
	export default {
		...
		props: {
			...
			max: {
				type: Number,
				default: 1000000000000000000000000000000000000000
			},
			step: {
				type: Number,
				default: 1
