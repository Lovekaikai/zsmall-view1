	...
	<view class="serach">
		<view class="content" :style="{'border-radius':radius+'px'}">
			...
			<view class="content-box" :class="{'center':mode === 2}" @click="getFocus">
				...
				<input style="height: 100%;" :placeholder="placeholder" @input="inputChange" confirm-type="search" @confirm="triggerConfirm"
				 class="input" :class="{'center':!active && mode === 2}" :focus="isFocus" v-model="inputVal" @focus="focus" @blur="blur" />
